...
function bounce_Off(object_1, object_2){

    if(object_1.x-object_2.x<object_1.width/2+object_2.width/2 &&
    ...
    if(object_1.y-object_2.y<object_1.height/2+object_2.height/2 &&
  ...
  function collision(object_1, object_2){
    if(object_1.x-object_2.x<object_1.width/2+object_2.width/2 &&
      object_2.x-object_1.x<object_1.width/2+object_2.width/2 &&
      object_1.y-object_2.y<object_1.height/2+object_2.height/2 &&
      object_2.y-object_1.y<object_1.height/2+object_2.height/2
      ){
      return true;
    }else{
